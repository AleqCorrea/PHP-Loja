	...
	<div class="row mt-3">
		...
		<div class="col-md-9">
			<div class="row">
				...
				$x = 0;
				//paginação
				$total = $todos->num_rows;//qtd itens
				$pp = 6;//qtd por pagina
				$paginas = ceil($total/$pp);//definimos o total de pgs
				//definindo o padrão de exibicao da pagina 1
				$atual = isset($_GET['p']) ? $_GET['p'] : 1;
				//conta que determina a regra da consulta SQL
				$inicio = ($atual -1) *$pp;

				$sql = 	"SELECT * FROM produto LIMIT $inicio ,$pp";
